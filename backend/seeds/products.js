 ...
 * Product Seed Data
 *
 * This file contains the initial product data for seeding the database.
 * Run this seed file to populate the demo-products.json with fresh data.
 */
...
const products = [
  ...
  },
  {
    ...
    images: [
      {
        id: "img6",
        url: "https://placehold.co/600x600/0F0F14/C9A961?text=Runes+%26+Pages",
  ...
  },
  {
    ...
    images: [
      {
        id: "img7",
        url: "https://placehold.co/600x800/1C1F26/E8DCC4?text=Build+Yourself",
  ...
  },
  {
    ...
    images: [
      {
        id: "img8",
        url: "https://placehold.co/600x600/2B1B3D/E6D5B8?text=Moonlit+Path",
